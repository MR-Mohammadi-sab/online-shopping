...
function  Nav() {
    ...
    return(
        <div className='flex px-2 py-2  items-center bg-red-800 justify-between text-xl text-zinc-100 z-10 fixed top-0 w-full bg-opacity-20'>
            ...
            <div className='mx-11 cursor-pointer active:translate-y-0.5 p-1  hover:text-zinc-200 rounded-lg'><Link to='/online-shopping'>shop</Link> </div>
            <div className='relative cursor-pointer active:translate-y-0.5   p-1 hover:text-zinc-200 rounded-lg'><Link to='/card'><FontAwesomeIcon icon={faShoppingCart} /></Link>
